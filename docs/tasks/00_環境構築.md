...
- [ ] `deno task dev` で開発サーバーが起動する
- [ ] データベースに接続できる（Prisma Studio で確認）
- [ ] `locals.user` にモックユーザーが設定される
- [ ] TypeScript 型チェックがエラーなく通る
- [ ] ビルドが成功する
