...
**ドキュメント**: `docs/setup/MOCK_AUTH.md`
...
### 5.2 **Supabase Auth 実装ガイド**

**ドキュメント**: `docs/setup/SUPABASE_AUTH.md`

**内容**:
- Supabase Auth (GitHub OAuth) のセットアップ手順
- Cookie管理とトークン更新の詳細
- 認証フロー図（ログイン/セッション確認/ログアウト）
- API エンドポイント実装例
- セキュリティチェックリスト
- トラブルシューティング
...
│   │   ├── MOCK_AUTH.md               # モック認証ガイド
│   │   └── SUPABASE_AUTH.md           # Supabase Auth 実装ガイド
│   └── tech/                          # 技術ドキュメント（既存）
└── （その他プロジェクトファイル）
```
